...
with st.sidebar:
    ...
    st.markdown("<div style='color:red; font-size:30px; position:absolute; top:-8vh;'>EyeSee TURF simulator<br><p style='color:gray'>Air Freshener Product Optimization project</p></div>", unsafe_allow_html=True)
    st.markdown("#")
    st.markdown("#")
