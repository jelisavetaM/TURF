...
with st.sidebar:
    ...
    if AutoChannel and not Walmart:
        ...
        originalTURF = originalTURF.drop(df.loc[:, 'Arm Hammer Hidden Cabana Breeze car air freshener 2 5 oz 4 99':'Yankee Candle Vent Stick Pink Sands 6 49'].columns,axis = 1)
